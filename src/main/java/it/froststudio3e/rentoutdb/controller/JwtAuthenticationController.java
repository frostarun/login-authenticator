...
import it.froststudio3e.rentoutdb.model.JwtResponse;
import it.froststudio3e.rentoutdb.model.Users;
import it.froststudio3e.rentoutdb.service.JwtUserDetailsService;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<?> saveUser(@RequestBody Users user) throws Exception {
        ...
        Users res = Users.builder().username(user.getUsername()).build();
